...
revised baseline. See settylab/nexus-code#79 for the
...
5. **Not operator-engaged.** A live `operator-engaged`
   ...
   upstream `#205` follow-up the mark is **self-expiring**
...
`wrapped-with-children`, settylab/nexus-code#455 refine): the
